...
int main (int argc, char* args[]){
   ...
   SDL_Init(SDL_INIT_EVERYTHING); //iniciar o sdl
	...
	while(executando){
        ...
        glColor4ub(255,0,0,100); // vermelho
        ...
        glVertex2f(550,50); // coordenadas do ponto 2 em 2D

        glColor4ub(0,255,0,100); // VERDE -> PARA COLOCAR QUADRADO EM 2 CORES
        glVertex2f(550,350); // coordenadas do ponto 3 em 2D
        glVertex2f(50,350); // coordenadas do ponto 4 em 2D

        //fecha o desenho
        glEnd();

        // se quiser desenhar no retângulo desenhado:
